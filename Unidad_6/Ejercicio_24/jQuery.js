...
$(function () {
  ...
  $(".mostrar")
    ...
    .insertAfter(".mostrar")
    .attr("class", "eliminar")
    .text("Eliminar"); //Clona el boton mostrar y lo inserta despues de este. Cambia el nombre de la clase con el metodo attr() y sustituye el cotenido de texto con el metodo text()
