...
let b = 4;
let c = 5;
console.log("Asignacion y operaciones");
console.log("i.(a*b)/c= " + (a + b) / c);
console.log("ii.(b+c)*a= " + (b + c) / c);
console.log("iii.(a/b)-(a+c)= " + a / b - (a + c));
...
console.log("Bolean");
console.log(w + " and " + r + " = " + (w && r));
console.log(w + " or " + r + " = " + (w || r));
